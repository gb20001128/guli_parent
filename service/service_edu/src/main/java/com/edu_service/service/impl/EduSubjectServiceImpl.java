...
import com.edu_service.entity.subject.TwoSubject;
import com.edu_service.listener.SubjectExcelListener;
import com.edu_service.mapper.EduSubjectMapper;
...
public class EduSubjectServiceImpl extends ServiceImpl<EduSubjectMapper, EduSubject> implements EduSubjectService {
    ...
    public List<OneSubject> getAllOneTwoSubject() {
        ...
        // 下面无中生有的baseMapper其实已经注入了,因为此类继承了ServiceImpl,ServiceImpl里注入的baseMapper)
        ...
        for (int i = 0; i < oneSubjectList.size(); i++) { //遍历oneSubjectList集合
            ...
            //eduSubject对象取各个属性值复制到对应oneSubject对象里面
